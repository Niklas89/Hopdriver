...
$retour_total=$bdd->query('SELECT COUNT(*) AS total FROM clients');
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-9">
                    <div class="checkbox">
                        <label>
                            <!--<input class="i-check" type="checkbox" />-->Our clients:</label>
                    </div>
                  ...
                  $premiereEntree=($pageActuelle-1)*$messagesParPage; // On calcul la première entrée à lire
                              ...
                              $retour_messages=$bdd->query('SELECT * FROM clients ORDER BY id DESC LIMIT '.$premiereEntree.', '.$messagesParPage.'');
                              ...
                              { 
                                ...
                                ?>
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo $resultat->address; ?> <?php echo $resultat->postal_code; ?></td>

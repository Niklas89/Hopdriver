...
$retour_total=$bdd->query('SELECT COUNT(*) AS total FROM chauffeurs');
...
<head>
    <title>Voklee - New Transfers</title>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-9">
                    <div class="checkbox">
                        <label>
                            <!--<input class="i-check" type="checkbox" />-->Our faithful and trustworthy little drivers:</label>
                    </div>
                  ...
                  $premiereEntree=($pageActuelle-1)*$messagesParPage; // On calcul la première entrée à lire
                              ...
                              $retour_messages=$bdd->query('SELECT * FROM chauffeurs ORDER BY id DESC LIMIT '.$premiereEntree.', '.$messagesParPage.'');
                              ...
                              { 
                                ...
                                ?>
                                        ...
                                        <tr>
                                            <td class="booking-history-title"><?php echo $resultat->company; ?>
                                            </td>
                                            <td><?php echo $resultat->email; ?></td>
                                            <td><?php echo $resultat->first_name; ?> <?php echo $resultat->last_name; ?></td>
                                            <td><?php echo $resultat->city; ?>, <?php echo $resultat->country; ?></td>
                                            <td><?php echo $resultat->phone; ?></td>
                                            <td class="text-center"><?php echo $resultat->date_inscription; ?></td>
                                            <td><a class="btn btn-info btn-sm" href="driverdetails.php?id=<?php echo $resultat->id; ?>" title="More details">Infos</a></td>
                                        </tr>

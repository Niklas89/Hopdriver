...
$retour_total=$bdd->query('SELECT COUNT(*) AS total FROM transfers_booking');
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-9">
                    <div class="checkbox">
                        <label>
                            <!--<input class="i-check" type="checkbox" />-->Accept transfers in the list below:</label>
                    </div>
                  ...
                  $premiereEntree=($pageActuelle-1)*$messagesParPage; // On calcul la première entrée à lire
                              ...
                              $retour_messages=$bdd->query('SELECT * FROM transfers_booking ORDER BY id DESC LIMIT '.$premiereEntree.', '.$messagesParPage.'');
                              ...
                              { 
                                ...
                                ?>
                                        ...
                                        <tr>
                                            ...
                                            <td><a class="btn btn-info btn-sm" href="transferdetails.php?id=<?php echo $resultat->id; ?>" title="More details">Infos</a></td>

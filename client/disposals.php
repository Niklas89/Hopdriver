...
$retour_total=$bdd->query('SELECT COUNT(*) AS total FROM disposal_booking WHERE clientid='.$id_users.'');
            ...
            <div class="row">
                ...
                <div class="col-md-9">
                  ...
                  $premiereEntree=($pageActuelle-1)*$messagesParPage; // On calcul la première entrée à lire
                              ...
                              $retour_messages=$bdd->query('SELECT * FROM disposal_booking WHERE clientid='.$id_users.' ORDER BY id DESC LIMIT '.$premiereEntree.', '.$messagesParPage.'');
                              ...
                              { 
                                ...
                                ?>
                                        ...
                                        <tr>
                                            ...
                                            <td><a class="btn btn-info btn-sm" href="disposaldetails.php?id=<?php echo $resultat->id; ?>" title="<?php echo _('View details'); ?>"><?php echo _('View'); ?></a></td>
                                            <?php

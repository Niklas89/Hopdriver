...
$id = $_GET['id'];
  ...
  $sth = $bdd->prepare("SELECT driverid, clientid FROM transfers_booking WHERE id = ".$id);
...
<body>
    ...
    <div class="global-wrap">
        ...
        <div class="container">
            <h1 class="page-title"><?php echo _('Transfer Details'); ?></h1>
        </div>
                    ...
                    <table class="table table-bordered table-striped table-booking-history">
                      ...
                      while( $resultat = $resultats->fetch() )
                      {
                                ...
                                ?>
                                       ...
                                       <tr><td class="booking-history-title"><?php echo _('Price'); ?></td><td><?php echo $resultat->price; ?>€</td></tr>

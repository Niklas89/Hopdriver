...
if (!empty($_POST["pick_up_loc"]) && !empty($_POST["drop_off_loc"]) ) {
...
<head>
    <title>HopDriver - <?php _("Confirm Disposal"); ?></title>


    <meta content="text/html;charset=utf-8" http-equiv="Content-Type">
    <meta name="keywords" content="<?php _("Confirm Disposal"); ?>" />
    <meta name="description" content="<?php _("Confirm Disposal"); ?>">
...
<body>
    ...
    <div class="global-wrap">
        ...
        <div class="container">
            <ul class="breadcrumb">
                ...
                <li><a action="#" style="cursor:pointer;" onclick="goBack()"><?php echo _("Disposal Services"); ?></a>
                </li>
            ...
            <div class="booking-item-details">
                ...
                <header class="booking-item-header">
                    <div class="row">
                        <div class="col-md-9">
                            <h2 class="lh1em"><?php echo $servicesname; ?> <?php echo _('Hourly Disposal'); ?></h2>
                        </div>
                        <div class="col-md-3">
                            <p class="booking-item-header-price"><small></small>  <span class="text-lg"><?php echo $price; ?>€</span>/<?php echo _("hour"); ?></p>
                        </div>
                    </div>
                </header>
                            ...
                            <div class="col-md-7">
                                <div class="booking-item-price-calc">
                                    <div class="row row-wrap">
                                        ...
                                        <div class="col-md-5">
                                            <form id="<?php echo $services; ?>form" action="disposal-payment-unregistered.php" method="post">

                                            <ul class="list">
                                                <li>
                                                    <p>Price per hour <span><?php echo $price; ?>€</span>
                                                    </p>
                                                </li>
                                                <li>
                                                    <p>Total <span><span id="car-total" data-value="140"><?php echo $totalprice; ?>€</span></span>
                                                    </p>
                                                </li>

                                             </ul>
                                <input type="hidden" name="pick_up_loc" id="origin" value="<?php echo $pick_up_loc; ?>" />
                                <input type="hidden" name="drop_off_loc" id="destination" value="<?php echo $drop_off_loc; ?>" />
                                ...
                                <input type="hidden" name="item_name" id="item_name" value="Disposal - <?php echo $servicesname; ?>">
                                    ...
                                    $vehicles_exploded = explode(",",$vehicles);
                                        foreach ($vehicles_exploded as $vehicle) {
                                          ...
                                          <?php  }
                                            ...
                                            <button id="checkout" name="checkout" class="btn btn-primary"><?php echo _("Book"); ?></button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="booking-item-deails-date-location">
                             <ul>
                                <li>
                                    ...
                                    <p><i class="fa fa-map-marker box-icon-inline box-icon-gray"></i><?php echo $pick_up_loc; ?></p>
                                ...
                                <li>
                                    ...
                                    <p><i class="fa fa-map-marker box-icon-inline box-icon-gray"></i><?php echo $drop_off_loc; ?></p>
                                    <p><i class="fa fa-calendar box-icon-inline box-icon-gray"></i><?php echo $drop_off_date; ?></p>
                                    <p><i class="fa fa-clock-o box-icon-inline box-icon-gray"></i><?php echo $drop_off_time; ?></p>
                                </li>

                                <li>
                                    <h5><?php echo _("Total hours"); ?>:</h5>
                                    <p><i class="fa fa-clock-o box-icon-inline box-icon-gray"></i><?php echo $hoursday; ?> /day</p>
                                </li>
                                <li>
    ...
    <script src="//maps.googleapis.com/maps/api/js?key=AIzaSyDHVg&libraries=places&language=en"></script>

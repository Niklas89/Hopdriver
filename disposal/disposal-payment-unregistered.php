...
<head>
    <title>HopDriver - <?php echo _("Disposal Booking"); ?></title>


    <meta content="text/html;charset=utf-8" http-equiv="Content-Type">
    <meta name="keywords" content="<?php echo _('Disposal Booking'); ?>" />
    <meta name="description" content="HopDriver - <?php echo _('Disposal Booking'); ?>">
...
<body>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-8">
                        ...
                        <?php include 'disposal-paypal-checkout.php'; ?>
                ...
                <div class="col-md-4">
                    <div class="booking-item-payment">
                        <header class="clearfix">
                            ...
                            <h5 class="booking-item-payment-title"><a href="#"><?php echo $servicesname; ?> <?php echo _('Disposal'); ?></a></h5>
                        </header>
                       <ul class="booking-item-payment-details">
                            <li>
                                <h5><?php echo _("Disposal dates"); ?></h5>
                                ...
                                <div class="booking-item-payment-date">
                                    <p class="booking-item-payment-date-day"><?php echo $drop_off_date; ?></p>
                                    <p class="booking-item-payment-date-weekday"><?php echo $drop_off_time; ?></p>
                                </div>
                            </li>
                            <li>
                                <h5><?php echo $servicesname; ?> (<?php echo $seats; ?> Passengers)</h5>
                                <ul class="booking-item-payment-price">
                                    <li>
                                        <p class="booking-item-payment-price-title"><?php echo _("Per hour"); ?></p>
                                        <p class="booking-item-payment-price-amount"><?php echo $price; ?>€</p>
                                    </li>
                                    <li>
                                        <p class="booking-item-payment-price-title"><?php echo _("Total"); ?></p>
                        ...
                        <p class="booking-item-payment-total"><?php echo _("Total trip"); ?>: <span><?php echo $totalprice; ?>€</span>
                        </p>
                    </div>
                </div>
            </div>
    ...
    <script src="//maps.googleapis.com/maps/api/js?key=AIzarDHVg&libraries=places&language=en"></script>

...
if (isset($_POST["services"])) {
    if($_POST["services"] == 'ecocar') { $servicesname = _('Sedan Economy');
                             ...
                             $req = $bdd->prepare('SELECT * FROM driver_photo WHERE driverid = :chauffeursid');
                              ...
                              else // check if row where there is this email doesn't exist
                                {
        ...
        <div class="container">
            ...
            <div class="booking-item-details">
                ...
                <header class="booking-item-header">
                    <div class="row">
                        <div class="col-md-9">
                            <h2 class="lh1em"><?php echo $servicesname; ?> <?php echo _('Transfer'); ?></h2>
                        </div>
                        <div class="col-md-3">
                    ...
                    <div class="col-md-9">
                        <div class="row">
                            ...
                            <div class="col-md-7">
                                ...
                                <input type="hidden" name="return" value="https://www.imagidev.com/">

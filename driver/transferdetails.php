...
<head>
    <title>HopDriver - <?php echo _('Transfer Details'); ?></title>
...
<body>
    ...
    <div class="global-wrap">
        ...
        <div class="container">
            <h1 class="page-title"><?php echo _('New Transfer'); ?></h1>
        </div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-9">
                    <div class="checkbox">
                        <label>
                            <!--<input class="i-check" type="checkbox" />--><?php echo _('Transfer details are indicated below'); ?>:</label>
                    </div>
                    <table class="table table-bordered table-striped table-booking-history">
                      ...
                      while( $resultat = $resultats->fetch() )
                      {
                                ...
                                ?>
                                        ...
                                        <tr><td class="booking-history-title"><?php echo _('Origin'); ?></td><td><?php echo $resultat->origin; ?></td></tr>
                                        <tr><td class="booking-history-title"><?php echo _('Destination'); ?></td><td><?php echo $resultat->destination; ?></td></tr>
                                        ...
                                        <tr><td class="booking-history-title"><?php echo _('Return Date'); ?></td><td><?php echo $resultat->returndate; ?></td></tr>
                                        <tr><td class="booking-history-title"><?php echo _('Return Time'); ?></td><td><?php echo $resultat->returntime; ?></td></tr> 
                                        ...
                                        <tr><td class="text-center"><a class="btn btn-warning btn-sm" href="transfers.php?cancel=<?php echo urlencode($resultat->id); ?>" title="<?php echo _('Cancel'); ?>"><?php echo _('Cancel'); ?></a></td>
                                            <td class="text-center"><i class="fa fa-check"></i></td></tr>
                                            <?php } else { ?>
                                        <tr><td class="text-center"><a class="btn btn-success btn-sm" href="transfers.php?valid=<?php echo urlencode($resultat->id); ?>" title="<?php echo _('Accept'); ?>"><?php echo _('Accept'); ?></a>

...
<head>
    <title>HopDriver - <?php echo _('Transfer Booked'); ?></title>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-8">
                        ...
                        <h3><?php echo _('Transfer Booked'); ?></h3>


                                                    <div class="alert alert-success">
                                                        <button class="close" type="button" data-dismiss="alert"><span aria-hidden="true">X</span>
                                                        </button>
                                                        <p class="text-small"><?php echo _('Your transfer has been booked!'); ?><br /><?php echo _('Now you just have to wait for the driver confirmation.'); ?></p>
                                                    </div> 
